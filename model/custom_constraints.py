...
def tokenizeEngWithSpacy(en_input, return_str=False, spacy_model='en_core_web_sm'): 
...
fbpe_code = open('model/bpe.codes', 'r', encoding='UTF-8')
fbpe_vocab_src = open('model/bpe.vocab.src.no_nbr', 'r', encoding='UTF-8')
fbpe_vocab_trg = open('model/bpe.vocab.trg.no_nbr', 'r', encoding='UTF-8')
...
def assembleJSON(line):
    ...
    return createJSON(en_line, bpe_src, bpe_trg, \
